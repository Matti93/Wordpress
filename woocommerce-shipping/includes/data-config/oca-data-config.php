...
return array(
   ...
   'origen'           => array(
	...
	'origin_idfranjahoraria' 	=> array(
		'title'           => __( 'Franja Horaria para retirar paquetes', 'woocommerce-shipping-oca' ),
		'type'            => 'select',
		'description'     => __( 'Obligatorio sólo para Orden de Retiro valores posibles: (8 a 17), (8 a 12) o (14 a 17)', 'woocommerce-shipping-oca' ),
		'default'         => '',
		'class'           => 'packing_method',
		'options'         => array(
			'1'       => __( '8hs a 17hs', 'woocommerce-shipping-oca' ),
			'2'       => __( '8hs a 12hs', 'woocommerce-shipping-oca' ),
			'3'       => __( '14hs a 17hs', 'woocommerce-shipping-oca' ),
		),		
		'desc_tip'        => true
    ),		
   ...
   'api_key'          => array(
		...
		'type'            => 'text',
		'description'     => __( 'Wanderlust API Key - versión de prueba gratuita, no cambiar.', 'woocommerce-shipping-oca' ),
   ...
   'api_confirmarretiro' => array(
		'title'           => __( 'Generación de Etiquetas', 'woocommerce-shipping-oca' ),
		'type'            => 'select',
		'description'     => __( 'Pendiente: el envío quedará alojado en el Carrito de Envíos de e-Pak a la espera de la confirmación del mismo. Directo: la confirmación será instantánea.', 'woocommerce-shipping-oca' ),
		'default'         => '',
		'class'           => 'packing_method',
		'options'         => array(
			'true'       => __( 'Directo', 'woocommerce-shipping-oca' ),
			'false'       => __( 'Pendiente', 'woocommerce-shipping-oca' ),
		),		
		'desc_tip'        => true
    ),
