...
$settings =  array(
    'single_method' => array(
        'title' 		=> __( 'Single method', 'shipping-zone-wcm' ),
        'type' 			=> 'select',
        'description' 	=> __( 'Seleccione Si para deshabilitar todos los metodos de envio', 'shipping-zone-wcm' ),
    ...
    'title' => array(
        'title' 		=> __( 'Titulo a mostrar en envio', 'woocommerce' ),
        'type' 			=> 'text',
        'description' 	=> __( 'This controls the title which the user sees during checkout.', 'woocommerce' ),
        'default'		=> __( 'Calculo de costo por localidad', 'woocommerce' ),
        'desc_tip'		=> true
    ),
    'tax_status' => array(
        'title' 		=> __( 'Valor del envio', 'woocommerce' ),
        'type' 			=> 'select',
        'class'         => 'wc-enhanced-select',
        'default' 		=> 'taxable',
        'options'		=> array(
    ...
    'cost' => array(
        'title' => __('Costo', 'shipping-zone-wcm'),
        'type' 			=> 'text',
    ...
    'cities' => array(
        'title' => __('Barrios o localidades','shipping-zone-wcm'),
        'type' => 'multiselect',
        'class'       => 'wc-enhanced-select',
        'description' => __( 'Select the city referring to the region that you have previously added', 'shipping-zone-wcm' ),
