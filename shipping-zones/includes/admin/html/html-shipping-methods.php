...
?>
    <tr valign="top">
        <th colspan="2" scope="row" class="titledesc"><?php echo __( 'Configured Calculo de costo por localidad  Methods in all shipping zones', 'shipping-zone-wcm' ) ?></th>
    </tr>
    <tr valign="top">
        <td colspan="2" class="forminp" id="<?php echo $this->id; ?>_rules_shipping_methods"><?php echo sprintf(__( 'This table shows <a href="%s">all shipping zones</a> and for each zone the shipping methods provided by this plugin.' , 'shipping-zone-wcm'), admin_url( 'admin.php?page=wc-settings&tab=shipping' ) ); ?>
            ...
            <table class="rules_shipping_methods wc-shipping-zones widefat striped" cellspacing="0">
                ...
                <tr>
                    ...
                    <th class="methods" ><?php echo __( 'Configured Calculo de costo por localidad methods' , 'shipping-filter-by-cities'); ?></th>
