    ...
    if ( ! class_exists( 'Filters_By_Cities_Method' ) ) {
        ...
        class Filters_By_Cities_Method extends WC_Shipping_Method
        {
            ...
            public function __construct($instance_id = 0)
            {
                ...
                $this->method_title       = __( 'Calculo de costo por localidad', 'shipping-zone-wcm' );
                $this->method_description = __( 'Agregue costos de envio a cada localidad', 'shipping-zone-wcm' );
            ...
            public function showCitiesRegions()
            {
                ...
                foreach ($zones as $zone){
                    if (strpos($zone->code, ':') !== false){
                        ...
                        $states = WC_States_Places_Argentina::get_places( $place[0] );
