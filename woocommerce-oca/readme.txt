...
== Changelog ==
=2.0.5=
* Fix: Corregido bug que no permitía comprar con envío a puerta

= 2.0.4 =
* Hotfix: Corregimos Error de chequeo de clases cuando no era un producto

= 2.0.3 =
* Hotfix: Corregimos Sucursales mostradas por OCA
...
* Agregada página de configuración (Ajustes -> Configuración de OCA)
* Agregada posibilidad de sumar operativas ilimitadas
* Agregado link de configuración en la página de plugins
* Arreglado bug sobre dimensiones de producto
* Arreglado botón de ver etiqueta en el panel de ordenes
* Código optimizado
* Los logs ahora serán más descriptivos y contendrán solo información necesaria

= 1.7.2 =
* Arreglado bug donde los envíos asegurados no calculaban su precio correctamente
